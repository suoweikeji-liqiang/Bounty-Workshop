...
STALE_PROGRESS_THRESHOLD_DAYS_KEY = "stale_progress_threshold_days"
DEFAULT_STALE_PROGRESS_THRESHOLD_DAYS = 3
MIN_STALE_PROGRESS_THRESHOLD_DAYS = 1
STALE_PROGRESS_REMINDER_COOLDOWN_HOURS_KEY = "stale_progress_reminder_cooldown_hours"
DEFAULT_STALE_PROGRESS_REMINDER_COOLDOWN_HOURS = 24
MIN_STALE_PROGRESS_REMINDER_COOLDOWN_HOURS = 1
